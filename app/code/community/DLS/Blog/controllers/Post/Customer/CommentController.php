...
class DLS_Blog_Post_Customer_CommentController extends Mage_Core_Controller_Front_Action {
    ...
    public function indexAction() {
        ...
        if ($navigationBlock = $this->getLayout()->getBlock('customer_account_navigation')) {
            $navigationBlock->setActive('dls_blog/post_customer_comment/');
        }
    ...
    public function viewAction() {
        ...
        $comment = Mage::getModel('dls_blog/post_comment')->load($commentId);
        if (!$comment->getId() ||
                $comment->getCustomerId() != Mage::getSingleton('customer/session')->getCustomerId() ||
                $comment->getStatus() != DLS_Blog_Model_Post_Comment::STATUS_APPROVED) {
