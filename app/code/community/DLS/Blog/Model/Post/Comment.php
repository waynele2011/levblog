...
class DLS_Blog_Model_Post_Comment extends Mage_Core_Model_Abstract {

    const STATUS_PENDING = 0;
    const STATUS_APPROVED = 1;
    const STATUS_REJECTED = 2;
    const ENTITY = 'dls_blog_post_comment';
    const CACHE_TAG = 'dls_blog_post_comment';

    protected $_eventPrefix = 'dls_blog_post_comment';
