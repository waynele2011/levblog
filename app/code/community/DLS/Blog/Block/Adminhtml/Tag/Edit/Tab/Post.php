...
class DLS_Blog_Block_Adminhtml_Tag_Edit_Tab_Post extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(
                array('related' => $collection->getTable('dls_blog/tag_post')), 'related.post_id=e.entity_id AND ' . $constraint, array('position')
        );
