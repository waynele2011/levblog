...
class DLS_Blog_Block_Adminhtml_Filter_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('dls_blog/filter')
                ->getCollection();
    ...
    protected function _prepareMassaction() {
        ...
        $this->getMassactionBlock()->addItem(
                'exposed', array(
            'label' => Mage::helper('dls_blog')->__('Change Exposed filter'),
            ...
            'additional' => array(
                'flag_exposed' => array(
                    ...
                    'values' => array(
                        '1' => Mage::helper('dls_blog')->__('Yes'),
                        '0' => Mage::helper('dls_blog')->__('No'),
                    )
                )
            )
                )
        ...
        $this->getMassactionBlock()->addItem(
                'type', array(
            'label' => Mage::helper('dls_blog')->__('Change Filter type'),
            ...
            'additional' => array(
                'flag_type' => array(
                    ...
                    'values' => Mage::getModel('dls_blog/filter_attribute_source_type')
                            ->getAllOptions(true),
                )
            )
                )
