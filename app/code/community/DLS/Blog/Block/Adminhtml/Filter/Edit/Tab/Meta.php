...
class DLS_Blog_Block_Adminhtml_Filter_Edit_Tab_Meta extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset(
                'filter_meta_form', array('legend' => Mage::helper('dls_blog')->__('Meta Information'))
        );
        $fieldset->addField(
