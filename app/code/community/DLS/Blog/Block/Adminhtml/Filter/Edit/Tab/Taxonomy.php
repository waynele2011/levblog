...
class DLS_Blog_Block_Adminhtml_Filter_Edit_Tab_Taxonomy extends DLS_Blog_Block_Adminhtml_Taxonomy_Tree {
    ...
    public function __construct() {
        parent::__construct();
        $this->setTemplate('dls_blog/filter/edit/tab/taxonomy.phtml');
    }
