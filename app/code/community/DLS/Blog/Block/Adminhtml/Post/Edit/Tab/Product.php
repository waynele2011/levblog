...
class DLS_Blog_Block_Adminhtml_Post_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->joinField(
                'position', 'dls_blog/post_product', 'position', 'product_id=entity_id', $constraint, 'left'
        );
