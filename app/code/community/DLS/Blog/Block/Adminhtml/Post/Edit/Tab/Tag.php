...
class DLS_Blog_Block_Adminhtml_Post_Edit_Tab_Tag extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(
                array('related' => $collection->getTable('dls_blog/post_tag')), 'related.tag_id=main_table.entity_id AND ' . $constraint, array('position')
        );
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn(
            ...
            'base_link' => 'adminhtml/blog_tag/edit',
                )
        );
        $this->addColumn(
                'position', array(
