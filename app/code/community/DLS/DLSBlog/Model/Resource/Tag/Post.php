 ...
 */
class DLS_DLSBlog_Model_Resource_Tag_Post extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('dls_dlsblog/tag_post', 'rel_id');
    }
     ...
     * @param array $data
     * @return DLS_DLSBlog_Model_Resource_Tag_Post
     * @author Ultimate Module Creator
     */
