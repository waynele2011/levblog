 ...
 */
class DLS_DLSBlog_Model_Resource_Filter extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('dls_dlsblog/filter', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return DLS_DLSBlog_Model_Resource_Filter
     * @author Ultimate Module Creator
     */
