 ...
 */
class DLS_DLSBlog_Model_Resource_Post_Comment_Post_Collection extends DLS_DLSBlog_Model_Resource_Post_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('dls_dlsblog/post_comment_store');
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('dls_dlsblog/post_comment');
