...
class DLS_DLSBlog_Model_Resource_Post_Comment extends Mage_Core_Model_Resource_Db_Abstract {
    ...
    protected function _getLoadSelect($field, $value, $object) {
        ...
        if ($object->getStoreId()) {
            ...
            $select->join(
                            array('dlsblog_post_comment_store' => $this->getTable('dls_dlsblog/post_comment_store')), $this->getMainTable() . '.comment_id = dlsblog_post_comment_store.comment_id', array()
                    )
