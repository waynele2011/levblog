...
/**
 * Taxonomy - Filter relation resource model collection
 *
 * @category    DLS
 * @package     DLS_DLSBlog
 * @author      Ultimate Module Creator
 */
class DLS_DLSBlog_Model_Resource_Taxonomy_Filter_Collection extends DLS_DLSBlog_Model_Resource_Filter_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('dls_dlsblog/taxonomy_filter')),
                'related.filter_id = main_table.entity_id',
                array('position')
            );
