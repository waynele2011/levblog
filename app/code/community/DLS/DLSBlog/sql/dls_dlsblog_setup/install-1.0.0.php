...
$table = $this->getConnection()
        ...
        ->addColumn(
                'updated_at', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(), 'Blog setting Modification Time'
        )
        ->addColumn(
                'created_at', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(), 'Blog setting Creation Time'
        )
...
$table = $this->getConnection()
        ...
        ->addColumn(
                'is_menu', Varien_Db_Ddl_Table::TYPE_SMALLINT, null, array(
            'nullable' => false,
...
$table = $this->getConnection()
        ...
        ->addColumn(
                'condition_code', Varien_Db_Ddl_Table::TYPE_TEXT, '64k', array(), 'Condition code'
        )
        ->addColumn(
        ...
        ->addIndex($this->getIdxName('dls_dlsblog/taxonomy', array('taxonomy_id')), array('taxonomy_id'))
        ->addIndex($this->getIdxName('dls_dlsblog/layoutdesign', array('layoutdesign_id')), array('layoutdesign_id'))
...
$table = $this->getConnection()
        ...
        ->addColumn(
                'design_code', Varien_Db_Ddl_Table::TYPE_TEXT, '64k', array(), 'Design code'
        )
        ->addColumn(
                'status', Varien_Db_Ddl_Table::TYPE_SMALLINT, null, array(), 'Enabled'
        )
...
$table = $this->getConnection()
        ...
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/post', array('entity_type_id')
                ), array('entity_type_id')
        )
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/post', array('attribute_set_id')
                ), array('attribute_set_id')
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post', 'attribute_set_id', 'eav/attribute_set', 'attribute_set_id'
        ...
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post', 'entity_type_id', 'eav/entity_type', 'entity_type_id'
...
foreach ($postEav as $type => $options) {
    $table = $this->getConnection()
            ...
            ->addIndex(
                    $this->getIdxName(
                            array('dls_dlsblog/post', $type), array('entity_id', 'attribute_id', 'store_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
                    ), array('entity_id', 'attribute_id', 'store_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE)
            )
            ->addIndex(
                    $this->getIdxName(
                            array('dls_dlsblog/post', $type), array('store_id')
                    ), array('store_id')
            )
            ->addIndex(
                    $this->getIdxName(
                            array('dls_dlsblog/post', $type), array('entity_id')
                    ), array('entity_id')
            )
            ->addIndex(
                    $this->getIdxName(
                            array('dls_dlsblog/post', $type), array('attribute_id')
                    ), array('attribute_id')
            )
            ->addForeignKey(
                    $this->getFkName(
                            array('dls_dlsblog/post', $type), 'attribute_id', 'eav/attribute', 'attribute_id'
            ...
            ->addForeignKey(
                    $this->getFkName(
                            array('dls_dlsblog/post', $type), 'entity_id', 'dls_dlsblog/post', 'entity_id'
                    ), 'entity_id', $this->getTable('dls_dlsblog/post'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
            )
            ->addForeignKey(
                    $this->getFkName(
                            array('dls_dlsblog/post', $type), 'store_id', 'core/store', 'store_id'
...
$table = $this->getConnection()
        ...
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/post_product', array('product_id')
                ), array('product_id')
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_product', 'post_id', 'dls_dlsblog/post', 'entity_id'
                ), 'post_id', $this->getTable('dls_dlsblog/post'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_product', 'product_id', 'catalog/product', 'entity_id'
                ), 'product_id', $this->getTable('catalog/product'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/post_product', array('post_id', 'product_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
...
$table = $this->getConnection()
        ...
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_comment', 'post_id', 'dls_dlsblog/post', 'entity_id'
                ), 'post_id', $this->getTable('dls_dlsblog/post'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_comment', 'customer_id', 'customer/entity', 'entity_id'
...
$table = $this->getConnection()
        ...
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/post_comment_store', array('store_id')
                ), array('store_id')
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_comment_store', 'comment_id', 'dls_dlsblog/post_comment', 'comment_id'
                ), 'comment_id', $this->getTable('dls_dlsblog/post_comment'), 'comment_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_comment_store', 'store_id', 'core/store', 'store_id'
                ), 'store_id', $this->getTable('core/store'), 'store_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
...
$table = $this->getConnection()
        ...
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/blogset_taxonomy', 'blogset_id', 'dls_dlsblog/blogset', 'entity_id'
                ), 'blogset_id', $this->getTable('dls_dlsblog/blogset'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/blogset_taxonomy', 'taxonomy_id', 'dls_dlsblog/blogset', 'entity_id'
                ), 'taxonomy_id', $this->getTable('dls_dlsblog/taxonomy'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/blogset_taxonomy', array('blogset_id', 'taxonomy_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
...
$this->getConnection()->createTable($table);
$table = $this->getConnection()
        ->newTable($this->getTable('dls_dlsblog/filter_post'))
        ->addColumn(
                'rel_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'unsigned' => true,
            'identity' => true,
        ...
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/filter_post', 'filter_id', 'dls_dlsblog/filter', 'entity_id'
                ), 'filter_id', $this->getTable('dls_dlsblog/filter'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/filter_post', 'post_id', 'dls_dlsblog/filter', 'entity_id'
                ), 'post_id', $this->getTable('dls_dlsblog/post'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/filter_post', array('filter_id', 'post_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
                ), array('filter_id', 'post_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE)
        )
        ->setComment('Filter to Post Linkage Table');
$this->getConnection()->createTable($table);
$table = $this->getConnection()
        ...
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_tag', 'post_id', 'dls_dlsblog/post', 'entity_id'
                ), 'post_id', $this->getTable('dls_dlsblog/post'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addForeignKey(
                $this->getFkName(
                        'dls_dlsblog/post_tag', 'tag_id', 'dls_dlsblog/post', 'entity_id'
                ), 'tag_id', $this->getTable('dls_dlsblog/tag'), 'entity_id', Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE
        )
        ->addIndex(
                $this->getIdxName(
                        'dls_dlsblog/post_tag', array('post_id', 'tag_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE
                ), array('post_id', 'tag_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE)
        )
