...
class DLS_DLSBlog_Adminhtml_DLSBlog_Post_AttributeController extends Mage_Adminhtml_Controller_Action {
    ...
    protected function _initAction() {
        ...
        $this->loadLayout()
                ...
                ->_addBreadcrumb(
                        Mage::helper('dls_dlsblog')->__('Post'), Mage::helper('dls_dlsblog')->__('Post')
                )
                ->_addBreadcrumb(
                        Mage::helper('dls_dlsblog')->__('Manage Post Attributes'), Mage::helper('dls_dlsblog')->__('Manage Post Attributes')
        );
        return $this;
    }
    ...
    public function editAction() {
        ...
        $item = $id ? Mage::helper('dls_dlsblog')->__('Edit Post Attribute') : Mage::helper('dls_dlsblog')->__('New Post Attribute');
