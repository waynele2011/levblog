 ...
 */
class DLS_DLSBlog_Block_Adminhtml_Filter_Edit_Tab_Taxonomy extends DLS_DLSBlog_Block_Adminhtml_Taxonomy_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('dls_dlsblog/filter/edit/tab/taxonomy.phtml');
    }

    /**
     * Retrieve currently edited filter
     *
     * @access public
    ...
    /**
     * Return array with  IDs which the filter is linked to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getTaxonomyIds()
    {
        if (is_null($this->_taxonomyIds)) {
            $taxonomies = $this->getFilter()->getSelectedTaxonomies();
            $ids = array();
    ...
    /**
     * Returns array with nodes those are selected (contain current filter)
     *
     * @access protected
     * @return array
     * @author Ultimate Module Creator
