...
/**
 * post - taxonomy relation edit block
 *
 * @category    DLS
 * @package     DLS_DLSBlog
 * @author      Ultimate Module Creator
 */
class DLS_DLSBlog_Block_Adminhtml_Post_Edit_Tab_Taxonomy extends DLS_DLSBlog_Block_Adminhtml_Taxonomy_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('dls_dlsblog/post/edit/tab/taxonomy.phtml');
    }
