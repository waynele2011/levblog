...
/**
 * taxonomy - blogset relation edit block
 *
 * @category    DLS
 * @package     DLS_DLSBlog
 * @author      Ultimate Module Creator
 */
class DLS_DLSBlog_Block_Adminhtml_Taxonomy_Edit_Tab_Blogset extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    /**
     * prepare the blog setting collection
     *
     * @access protected
     * @return DLS_DLSBlog_Block_Adminhtml_Taxonomy_Edit_Tab_Blogset
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            array('related' => $collection->getTable('dls_dlsblog/taxonomy_blogset')),
            'related.blogset_id=main_table.entity_id AND '.$constraint,
            array('position')
        );
